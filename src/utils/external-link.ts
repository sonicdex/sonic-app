...
export abstract class ExternalLink {
  ...
  static readonly icpPrice = "https://api.coingecko.com/api/v3/simple/price?ids=internet-computer&vs_currencies=usd&precision=4" //`https://api.binance.com/api/v3/avgPrice?symbol=ICPUSDT`;
