...
// export const parseAmount = (val: string, decimals: string | number): bigint => {
//   try {
//     const parsedDecimals = typeof decimals === 'string' ? parseInt(decimals, 10) : decimals;
//     const parts = val.split('.');
//     const integerPart = parts[0] || '0';
//     const fractionalPart = parts[1] || '';
//     const trimmedFractionalPart = fractionalPart.replace(/^0+/, '');
//     const integerBigInt = BigInt(integerPart);
//     const fractionalBigInt = trimmedFractionalPart.length > parsedDecimals
//       ? BigInt(trimmedFractionalPart.slice(0, parsedDecimals))
//       : BigInt(trimmedFractionalPart.padEnd(parsedDecimals, '0'));
//     return integerBigInt * BigInt(10 ** parsedDecimals) + fractionalBigInt;
