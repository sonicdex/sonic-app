...
export namespace SwapIDL {
  ...
  export interface Swap {
    ...
    'addNatLabsToken' : (arg_0: string) => Promise<boolean>,
    'addToken' : (arg_0: Principal, arg_1: string) => Promise<TxReceipt>,
    'addTokenToBlocklist' : (arg_0: Principal, arg_1: TokenBlockType) => Promise<
        boolean
      >,
    'addTokenToBlocklistValidate' : (
        arg_0: Principal,
        arg_1: TokenBlockType,
      ) => Promise<ValidateFunctionReturnType>,
    'addTokenValidate' : (arg_0: Principal, arg_1: string) => Promise<
    ...
    'depositTo' : (arg_0: Principal, arg_1: Principal, arg_2: bigint) => Promise<
        TxReceipt
      >,
    'executeFundRecoveryForUser' : (arg_0: Principal) => Promise<TxReceipt>,
    ...
    'getBlockedTokens' : () => Promise<Array<[Principal, TokenBlockType]>>,
    ...
    'getNatLabsToken' : () => Promise<Array<[string, boolean]>>,
    ...
    'getUserICRC1SubAccount' : (arg_0: Principal) => Promise<string>,
    ...
    'removeNatLabsToken' : (arg_0: string) => Promise<boolean>,
    'removeTokenFromBlocklist' : (arg_0: Principal) => Promise<boolean>,
    'removeTokenFromBlocklistValidate' : (arg_0: Principal) => Promise<
        ValidateFunctionReturnType
      >,
    ...
    'setMaxTokenValidate' : (arg_0: bigint) => Promise<
        ValidateFunctionReturnType
      >,
    ...
    'updateTokenType' : (arg_0: Principal, arg_1: string) => Promise<boolean>,
    'updateTokenTypeValidate' : (arg_0: Principal, arg_1: string) => Promise<
        ValidateFunctionReturnType
      >,
    'validateExecuteFundRecoveryForUser' : (arg_0: Principal) => Promise<
        ValidateFunctionReturnType
      >,
    'validateRegisterFundRecoveryForUser' : (
        arg_0: Principal,
        arg_1: Principal,
        arg_2: bigint,
      ) => Promise<ValidateFunctionReturnType>,
