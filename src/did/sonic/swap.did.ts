...
export namespace SwapIDL {
  ...
  getBalance : (arg_0: Principal, arg_1: string) => Promise<bigint>,
  ...
  setDaoCanisterForLiquidity : (arg_0: Principal) => Promise<string>,
  ...
  swapTokensForExactTokens : ( arg_0: bigint, arg_1: bigint,arg_2: Array<string>,
      arg_3: Principal,
      arg_4: bigint,
    ) => Promise<TxReceipt>,
  ...
  export const factory: IDL.InterfaceFactory = ({ IDL }) => {
    ...
    const Swap = IDL.Service({
      ...
      exportSwapInfo: IDL.Func([], [SwapInfoExt], []),
