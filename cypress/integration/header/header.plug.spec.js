...
describe('UI validations for header items/Dark Mode', () => {
  ...
  it('Validates CSS properties for each navigation item', () => {
    ...
    //Liquidity tab 
    cy.checkCSSAttrsWithPlug(1, "Liquidity")
    //Assets tab
    cy.checkCSSAttrsWithPlug(2, "Assets")
    //Activity tab
    cy.checkCSSAttrsWithPlug(3, "Activity")
  })
  it('Connect to plug button', () => {
    cy.contains('Connect to Plug')
      .should('have.css', 'font-family', '"Nunito Sans"')
      .should('have.css', 'font-weight', '600')
  })
